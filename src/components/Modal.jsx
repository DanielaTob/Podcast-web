...
const Modal = ({titulo}) => {
  ...
  return (
    ...
    <div className="">
      <button
      className="px-8 py-3 border border-transparent text-base leading-6 font-light rounded-lg text-white bg-bluelight focus:outline-none focus:border-green focus:shadow-outline-indigo transition duration-150 ease-in-out"
